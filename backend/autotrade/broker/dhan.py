"""Dhan broker client — STUB. Not yet implemented.

Placeholder so the BrokerRouter can recognise the broker name. Every method
raises NotImplementedError. Implement by wrapping the Dhan SDK the same way
...
class DhanBroker(BrokerClient):
    ...
    def _ni(self, what: str):
        raise NotImplementedError(
            f"Dhan broker not implemented yet: {what}. "
            "Wrap the Dhan SDK following autotrade/broker/zerodha.py."
        )
