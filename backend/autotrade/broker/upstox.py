"""Upstox broker client — STUB. Not yet implemented.

Placeholder so the BrokerRouter can recognise the broker name. Every method
raises NotImplementedError. Implement by wrapping the Upstox SDK the same way
...
class UpstoxBroker(BrokerClient):
    ...
    def _ni(self, what: str):
        raise NotImplementedError(
            f"Upstox broker not implemented yet: {what}. "
            "Wrap the Upstox SDK following autotrade/broker/zerodha.py."
        )
