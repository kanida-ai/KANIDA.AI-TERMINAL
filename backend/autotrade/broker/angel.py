"""Angel broker client — STUB. Not yet implemented.

Placeholder so the BrokerRouter can recognise the broker name. Every method
raises NotImplementedError. Implement by wrapping the Angel SDK the same way
...
class AngelBroker(BrokerClient):
    ...
    def _ni(self, what: str):
        raise NotImplementedError(
            f"Angel broker not implemented yet: {what}. "
            "Wrap the Angel SDK following autotrade/broker/zerodha.py."
        )
