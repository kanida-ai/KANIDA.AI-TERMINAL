...
falcon-ohlc|at:Asia/Kolkata:16:15:1-5|$FALCON/scripts|exec "$RUNAT" Asia/Kolkata 16:15 1-5 falcon-ohlc -- /usr/bin/env KANIDA_NO_AUTH_MINT=1 KANIDA_SKIP_REPAIR=1 "$FPY" -u fetch_universe.py >> "$FALCON/logs/fetch_universe_daily.log" 2>&1
