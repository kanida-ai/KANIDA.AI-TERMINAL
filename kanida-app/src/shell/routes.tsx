...
export const NAV_ITEMS:NavItem[]=[{route:'/',label:'Falcon',short:'Falcon',icon:'cpu'},{route:'/discover',label:'Discover Strategies',short:'Discover',icon:'grid'},{route:'/derivative',label:'Derivative',short:'Derivative',icon:'layers'},{route:'/strategies',label:'Strategies',short:'Strategies',icon:'sliders'},{route:'/watch',label:'Watchlist',short:'Watchlist',icon:'eye'},{route:'/autotrade',label:'AutoTrade',short:'AutoTrade',icon:'zap'}];
export function navActive(path:string):string|null{if(path==='/'||path==='/discover'||path==='/derivative'||path==='/strategies'||path==='/watch'||path==='/autotrade')return path;if(path==='/simulate'||path==='/activity')return '/autotrade';return null;}
