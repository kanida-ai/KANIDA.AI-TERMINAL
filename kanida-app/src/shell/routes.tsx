...
export const NAV_ITEMS:NavItem[]=[{route:'/',label:'Falcon',short:'Falcon',icon:'cpu'},{route:'/discover',label:'Market scans',short:'Scans',icon:'grid'},{route:'/derivative',label:'Derivative',short:'Derivative',icon:'layers'},{route:'/strategies',label:'Strategies',short:'Strategies',icon:'sliders'},{route:'/watch',label:'Watchlist',short:'Watchlist',icon:'eye'},{route:'/autotrade',label:'AutoTrade',short:'AutoTrade',icon:'zap'}];
